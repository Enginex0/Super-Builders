...
#
# Requires zeromount_spoof_mmap_metadata() and zeromount_get_static_vpath()
# to be present in zeromount-core.patch / zeromount.h.
#
...
inject_procmaps() {
    ...
    # 6.6: show_map_vma may not have static prefix
    awk '
